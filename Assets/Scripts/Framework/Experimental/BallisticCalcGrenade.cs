...
namespace Assets.Scripts.Framework.Experimental
{
    ...
    /// Each concretization relates to the specific dynamics of the projectiles, 
    /// and this class specifies fast missiles with a Reynolds number less than 1000 
    /// and thus a linear dependence of the velocity air velocity.
    /// </summary>
