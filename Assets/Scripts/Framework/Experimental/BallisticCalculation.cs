...
namespace Assets.Scripts.Framework.Experimental
{
    ...
    public abstract class BallisticCalculation : IBallisticCalculation
    {
        ...
        /// </summary>
        /// <param name="vx"></param>Y component speed. Vertical speed component. Transfers through reference.
        /// <param name="vy"></param>X component speed. Horizonatal speed component. Transfers through reference.
        /// <param name="x"></param>X position component. Horizontal component of the position (distance). Transfers through references.
        /// <param name="y"></param>Y position component. Vertical component of the position (height). Transfers through references.
        /// <param name="angle"></param>Angle of the projectile. Transfers through reference.
        /// <param name="t"></param>Time of the flight. Transfers through reference.
